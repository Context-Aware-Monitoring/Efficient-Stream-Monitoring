...
#         [
#             '%s/raw/concurrent_data/traces/boot_delete/' % global_config.DATA_DIR,
#             '%s/raw/concurrent_data/traces/image_create_delete/' % global_config.DATA_DIR, 
#             '%s/raw/concurrent_data/traces/network_create_delete/' % global_config.DATA_DIR
#         ],
#         seq=False,
#         window_size=1,
#         step=1,
...
# df = pd.read_csv('%s/con_context_host-traces_w1_s1.csv' % global_config.CONTEXT_DIR)
